...
public class WaveManager : MonoBehaviour
{
    ...
    {
        inputBuffer = new float[MESH_RANGE*MESH_RANGE];
        waveBuffer0 = new float[MESH_RANGE*MESH_RANGE];
        waveBuffer1 = new float[MESH_RANGE*MESH_RANGE];
    }
    ...
    void DoWave(float[] inputBuf, float[] prevBuf, float[] curBuf)
    {
    ...
    void ApplyWave(Mesh mesh, Vector3[] vertices, float[] curBuf)
    {
